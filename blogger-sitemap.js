...
function displayToc2() {
    ...
    while (b < postTitle.length) {
        ...
        do {
            ...
            if (postBaru[a] == true) {
                document.write(' - <span class="new">Latest!</span>')
            }
            document.write("</li>");
            a = a + 1
        } while (postLabels[a] == temp1);
...
document.write("<span style='font-size:0px;float:right;font-family:arial;margin:20px 5px 0 0;'><a title='Blogger TOC by Abu Farhan - Style by www.intert3chmedia.net' href='http://www.bloggerwidgetgenerators.com' target='_blank' rel='nofollow'><font color='#ff5f00'>Blogger Widgets</font></a></span>");
