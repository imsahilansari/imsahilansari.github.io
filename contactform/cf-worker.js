// Bot API Key
const BOT_TOKEN = "2006457534:AAHF1jrabaEUcO_gyh3IqvXIIUnqCO34RLs";

// Your Telegram USER ID
const USERID = "726842402";
...
async function handleRequest(request) {
  if (request.method == "OPTIONS") {
    ...
    return Response.redirect(
      "https://imsahilansarii.github.io",
      301
    );
  } else {
      ...
      return new Response(
        ...
        }),
        {
          ...
          headers: {
            ...
            "Access-Control-Allow-Origin": "*",
            "Made-By": "https://github.com/imsahilansarii",
          },
        }
      );
    } else {
